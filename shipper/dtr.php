...
<body>
    ...
    <div class="container mt-4">
        ...
        <form method="POST" action="download_dtr.php" class="d-flex flex-column flex-sm-row justify-content-center align-items-center my-3">
            ...
            <button type="submit" name="download_week" class="btn btn-primary mb-2 mb-sm-0 me-sm-2">
                <i class="fas fa-file-export"></i> DTR for Selected Week
            </button>
            <button type="submit" name="download_month" class="btn btn-primary">
                <i class="fas fa-file-export"></i> DTR for Whole Month
            </button>
        </form>
        ...
        <?php if ($employee): ?>
            ...
            <form method="POST" class="mb-4">
                ...
                <button type="submit" class="btn btn-secondary mt-3" style="color: #fff; font-weight:bold;">View DTR</button>
            </form>
